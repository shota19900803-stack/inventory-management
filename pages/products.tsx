...
const initialForm = { name: "", jan_code: "", sku: "", model_number: "", brand: "", category: "", stock_quantity: "0", cost_price: "", selling_price: "" };
...
export default function ProductsPage() {
  ...
  async function saveProduct(event: React.FormEvent) {
    ...
    setSaving(true);
    const payload = { name: form.name.trim(), jan_code: jan || null, sku: form.sku.trim() || null, model_number: form.model_number.trim() || null, brand: form.brand.trim() || null, category: form.category.trim() || null, stock_quantity: Number(form.stock_quantity || 0), cost_price: form.cost_price === "" ? null : Number(form.cost_price), selling_price: form.selling_price === "" ? null : Number(form.selling_price) };
