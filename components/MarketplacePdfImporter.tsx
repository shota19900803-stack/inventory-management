...
export default function MarketplacePdfImporter() {
  ...
  async function save() {
    if (!entries.length) return; setBusy(true); setMessage("");
    try {
